...
public class babyBirths {
    ...
    public Integer getRank(Integer year, String name, String gender) {
        FileResource fr = new FileResource(String.format("C:\\Users\\abhij\\Documents\\GItHub\\Java\\Coursera\\Baby Names miniProject\\us_babynames\\us_babynames_by_year\\yob%s.csv", year));
        int rank = 0;
        for (CSVRecord record : fr.getCSVParser(false)) {
